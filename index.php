        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Carlos Morais</span>
            </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i> Adicionar</a></li>
...
<!-- SlimScroll -->
<script src="publico/js/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="publico/js/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="publico/js/adminlte.min.js"></script>
